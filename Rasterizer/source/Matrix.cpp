...
namespace dae {
	...
	{
		//TODO W1
		//Vector3 originNC{ origin };
		//Vector3 fowardNC{ forward };
		//Vector3 upNC{ up };



		//Vector3	zaxis = (fowardNC - originNC).Normalized();
		//Vector3 xaxis = (Vector3::Cross(upNC, zaxis)).Normalized();
		//Vector3	yaxis = Vector3::Cross(zaxis, xaxis);

		//Vector4 line1{ xaxis.x, yaxis.x, zaxis.x, 0 };
		//Vector4 line2{ xaxis.y, yaxis.y, zaxis.z, 0 };
		//Vector4 line3{ xaxis.z, yaxis.z, zaxis.z, 0 };
		//Vector4 line4{ Vector3::Dot(xaxis, originNC) * -1,  Vector3::Dot(yaxis, originNC) * -1,  Vector3::Dot(zaxis, originNC) * -1, 1 };
